  ...
  return (
    <div className="flex flex-col justify-between rounded-2xl border border-line bg-white p-6 shadow-xs transition-shadow hover:shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-base font-bold text-ink sm:text-lg">Sales Analytics</h2>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 z-20 mt-1.5 w-24 animate-in fade-in zoom-in-95 rounded-xl border border-line bg-white py-1 shadow-lg duration-150">
      ...
      <div className="overflow-x-auto">
        <div className="h-[230px] min-w-[280px] sm:h-[250px]">
