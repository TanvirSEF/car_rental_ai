...
export function StatCards({
  ...
  return (
    <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr]">
      <div className="flex items-center justify-between rounded-2xl border border-line bg-white p-5 shadow-xs transition-shadow hover:shadow-sm sm:col-span-2 lg:col-span-1">
      ...
      <div className="flex min-h-[140px] flex-col justify-between rounded-2xl bg-[#FF843E] p-5 text-white shadow-xs transition-shadow hover:shadow-sm">
        ...
        <div className="mt-4">
          <p className="text-2xl font-extrabold text-white sm:text-3xl">{displaySales}</p>
          <p className="mt-0.5 text-xs font-medium text-white/90 sm:text-sm">No of Total Sales</p>
        </div>
      </div>
      ...
      <div className="flex min-h-[140px] flex-col justify-between rounded-2xl bg-[#0E2942] p-5 text-white shadow-xs transition-shadow hover:shadow-sm">
        ...
        <div className="mt-4">
          <p className="text-2xl font-extrabold text-white sm:text-3xl">{displayGoods}</p>
          <p className="mt-0.5 text-xs font-medium text-white/80 sm:text-sm">No of Purchased Goods</p>
        </div>
      </div>
    </section>
  )
