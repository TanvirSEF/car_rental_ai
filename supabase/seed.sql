...
insert into public.cars (name, brand, category, price_per_day, seats, transmission, fuel_type, image_url, status, description) values
  ...
  ('Swift',        'Suzuki', 'Economy',  30,  5, 'Manual',    'Petrol',   'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=800', 'available',   'Budget-friendly compact car, easy to park and cheap to run.'),
